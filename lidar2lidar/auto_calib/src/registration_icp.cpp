...
void ICPRegistrator::SetTargetCloud(const pcl::PointCloud<pcl::PointXYZI>::Ptr &gcloud,
...
void ICPRegistrator::SetSourceCloud(const pcl::PointCloud<pcl::PointXYZI>::Ptr &gcloud,
                                    const pcl::PointCloud<pcl::PointXYZI>::Ptr &ngcloud,
                                    const pcl::PointCloud<pcl::PointXYZI>::Ptr &cloud)
{
  src_gcloud_ = gcloud;
...
Eigen::Matrix4d ICPRegistrator::GetFinalTransformation() { return final_transformation_; }
...
double ICPRegistrator::CalculateICPError(const pcl::KdTreeFLANN<pcl::PointXYZI> &kdtree,
...
void ICPRegistrator::computeNormals(const pcl::PointCloud<pcl::PointXYZI>::Ptr in_pts,
